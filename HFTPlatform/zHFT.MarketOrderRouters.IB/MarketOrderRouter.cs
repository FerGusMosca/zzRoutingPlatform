...
namespace zHFT.MarketOrderRouters.IB
{
    public class OrderRouter : OrderRouterBase
    {
        #region Private Static Attributes

        private static string _UNIVERSAL_MARKET = "SMART";
        ...
        protected zHFT.OrderRouters.IB.Common.Configuration.Configuration IBConfiguration
        {
            get { return (zHFT.OrderRouters.IB.Common.Configuration.Configuration)Config; }
            set { Config = value; }
        }
        ...
        protected override void DoLoadConfig(string configFile, List<string> listaCamposSinValor)
        {
            ...
            Config = new zHFT.OrderRouters.IB.Common.Configuration.Configuration().GetConfiguration<zHFT.OrderRouters.IB.Common.Configuration.Configuration>(configFile, noValueFields);
        }
        ...
        protected Contract GetContract(Wrapper wrapper)
        {
            ...
            contract.Exchange = _UNIVERSAL_MARKET;
        ...
        protected Order GetNewOrder(Wrapper wrapper)
        {
            ...
            OrderConverter.AssignOrdType(orderInfo, ordType, null);
