...
{
    public class IOLStandaloneMarketDataManager : BaseManager
    {
        ...
        public IOLStandaloneMarketDataManager(OnLogMessage OnLogMsg, string pMainURL, string user, string pwd)
        {
