...
namespace zHFT.InstructionBasedMarketClient.IOL.Common.Wrappers
{
    public class InvertirOnlineMarketDataWrapper : MarketDataWrapper
    {
        #region Constructors

        public InvertirOnlineMarketDataWrapper(Security pSecurity, IConfiguration pConfig) 
