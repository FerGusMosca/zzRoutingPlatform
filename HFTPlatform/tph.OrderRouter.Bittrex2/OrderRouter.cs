...
namespace tph.OrderRouter.Bittrex2
{
    ...
    public class OrderRouter
    {
        public void TestRouting()
        {
            ...
            var bittrexRestClient2 = new BittrexRestClient();

            var bittrexRestClient = new BittrexRestClient(options =>
            {
                options.ApiCredentials =
                    new ApiCredentials("ad6ec72057b24afd9a5f292da4d8b496", "38ebce53581d44e38023861fbdf3a910");
