...
using zHFT.InstructionBasedMarketClient.BitMex.Common.DTO.Websockets.Auth;
...
namespace zHFT.InstructionBasedMarketClient.BitMex.DAL.Websockets
{
    public class BaseManager
    {
        ...
        protected static string WebSocketURL { get; set; }

        protected static UserCredentials UserCredentials { get; set; }

        protected static bool PendingRequestResponse { get; set; }

        protected static bool Initialized = false;

        protected static Dictionary<string, WebSocketSubscriptionResponse> ResponseRequestSubscriptions { get; set; }

        protected static Dictionary<string, WebSocketSubscriptionEvent> EventSubscriptions { get; set; }

        protected static object tSubscrLock = new object();

        public static AuthenticationResult AuthSubscriptionResult { get; set; }
        ...
        protected static async Task InvokeWebSocket(WebSocketSubscriptionRequest req)
        {
        ...
        protected static async Task InvokeAuthWebSocket(WebSocketAuthenticationRequest req)
        {
            if (AuthSubscriptionResult.ClientWebSocket.State == WebSocketState.Open)
            {
                try
        ...
        protected static async void RunLoopSubscriptions()
        {
            bool abort = false;
            while (!abort)
            {
        ...
        protected static async Task<Welcome> GetWelcomeMessage(ClientWebSocket WebSocketToUse)
        {
        ...
        protected static string SignHMACSHA256(string secret, string verb, string endpoint, int expires)
        {
        ...
        protected static async Task<AuthenticationResult> DoAuthenticate()
        {
        ...
        protected static async Task<AuthenticationResult> AuthenticateSubscriptions()
        {
        ...
        public static void SubscribeResponseRequest(string topic, OnSubscritionEvent pOnSubscriptionEvent,
        ...
        public static void SubscribeEvents(string topic, OnEvent pOnSubscriptionEvent)
        {
        ...
        public static async Task<AuthenticationResult> ConnectSubscriptions()
        {
            if (!Initialized)
            {
                try
