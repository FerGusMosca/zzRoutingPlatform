...
{
    public class ManualExecutionReportWrapper : Wrapper
    {
        ...
        public ManualExecutionReportWrapper(OrderDTO pOrder, OrdStatus pOrdStatus, ExecType pExecType,string pRejReason, IConfiguration pConfig)
        {
            Order = pOrder;
