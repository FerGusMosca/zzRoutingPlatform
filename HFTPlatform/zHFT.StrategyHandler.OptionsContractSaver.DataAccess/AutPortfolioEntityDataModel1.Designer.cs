...
namespace zHFT.StrategyHandler.OptionsContractSaver.DataAccess
{
    ...
    public partial class AutPortfolioEntities : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        /// <param name="symbol">No Metadata Documentation available.</param>
        /// <param name="date">No Metadata Documentation available.</param>
        /// <param name="size">No Metadata Documentation available.</param>
        /// <param name="side">No Metadata Documentation available.</param>
        /// <param name="price">No Metadata Documentation available.</param>
        /// <param name="underlying_price">No Metadata Documentation available.</param>
        /// <param name="option_id">No Metadata Documentation available.</param>
        public int insert_option_bids(global::System.String symbol, Nullable<global::System.DateTime> date, Nullable<global::System.Int32> size, global::System.String side, Nullable<global::System.Decimal> price, Nullable<global::System.Decimal> underlying_price, Nullable<global::System.Int64> option_id)
        {
            ObjectParameter symbolParameter;
            if (symbol != null)
            {
                symbolParameter = new ObjectParameter("symbol", symbol);
            }
            else
            {
                symbolParameter = new ObjectParameter("symbol", typeof(global::System.String));
            }
            ...
            ObjectParameter sideParameter;
            if (side != null)
            {
                sideParameter = new ObjectParameter("side", side);
            }
            else
            {
                sideParameter = new ObjectParameter("side", typeof(global::System.String));
            }
            ...
            ObjectParameter underlying_priceParameter;
            if (underlying_price.HasValue)
            {
                underlying_priceParameter = new ObjectParameter("underlying_price", underlying_price);
            }
            else
            {
                underlying_priceParameter = new ObjectParameter("underlying_price", typeof(global::System.Decimal));
            }
    
            ObjectParameter option_idParameter;
            if (option_id.HasValue)
            {
                option_idParameter = new ObjectParameter("option_id", option_id);
            }
            else
            {
                option_idParameter = new ObjectParameter("option_id", typeof(global::System.Int64));
            }
    
            return base.ExecuteFunction("insert_option_bids", symbolParameter, dateParameter, sizeParameter, sideParameter, priceParameter, underlying_priceParameter, option_idParameter);
        }
